 ...
 */
import type { ServiceLineDataUsageForBillingCycles } from './serviceLineDataUsageForBillingCycles';

export interface ServiceLineDataUsageForBillingCyclesPaginated {
  pageIndex?: number;
  limit?: number;
  isLastPage?: boolean;
  /** @nullable */
